...
void init_spi_pins(SPI_Type *ptr)
{
    ...
    } else  if (ptr == HPM_SPI2)
    {
        ...
        HPM_IOC->PAD[IOC_PAD_PC26].FUNC_CTL = IOC_PC26_FUNC_CTL_SPI2_SCLK | IOC_PAD_FUNC_CTL_LOOP_BACK_SET(1);
       ...
       } else  if (ptr == HPM_SPI3)
    {
        ...
        HPM_IOC->PAD[IOC_PAD_PA26].FUNC_CTL = IOC_PA26_FUNC_CTL_SPI3_SCLK | IOC_PAD_FUNC_CTL_LOOP_BACK_SET(1);
