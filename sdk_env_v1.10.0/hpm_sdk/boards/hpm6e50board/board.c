...
//    uint32_t pad_ctl_1 = IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(BOARD_LED_OFF_LEVEL);
...
void board_init_led_pins(void)
{
    ...
    //向PD00引脚写1
 //   gpio_set_pin_output_with_initial(BOARD_D_GPIO_CTRL, BOARD_D_GPIO_INDEX, BOARD_D_GPIO_PIN, board_get_led_gpio_off_level());
}
